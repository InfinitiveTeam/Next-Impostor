...
namespace Impostor.Hazel.Dtls
{
    ...
    public struct ClientHello
    {
        ...
        public static bool Parse(out ClientHello result, ByteSpan span)
        {
            ...
            // Accept any protocol version (Among Us uses version=0 for UDP obfuscation)
            result.ClientProtocolVersion = clientVersion;
            span = span.Slice(2);
    ...
    public struct HelloVerifyRequest
    {
        ...
        public static void Encode(ByteSpan span, EndPoint peerAddress, HMAC hmac, ProtocolVersion serverVersion = ProtocolVersion.DTLS1_2)
        {
            ByteSpan cookie = ComputeAddressMac(peerAddress, hmac);

            span.WriteBigEndian16((ushort)serverVersion);
    ...
    public struct ServerHello
    {
        ...
        public void Encode(ByteSpan span)
        {
            ...
            span.WriteBigEndian16((ushort)this.ServerVersion, 0);
            span = span.Slice(2);
